...
public class LAVersion implements Comparable<LAVersion> {
	...
	public LAVersion(String name, String id, int major, int minor, int patch, RTUReleaseTypes type, int build) {
		this.name = name;
		this.id = id;
		this.major = major;
		this.minor = minor;
	...
	@Override
	public int compareTo(LAVersion other) {
